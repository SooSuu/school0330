		...
		<div id="contents">
 			<div id="bbs_wrap">
				<div class="board_view">
					...
					<dl class="info_view">
						...
						<dt>신청기간</dt>
						<dd><c:out value="${reservation.reqstBgnde}"/> ~ <c:out value="${resreservationult.reqstEndde}"/></dd>
						<dt>신청 가능한 인원</dt>
					...
					<div class="view_cont">
						<c:out value="${reservation.resveCn}" escapeXml="fales"/>
					</div>
				</div>
			</div>
			...
			<form action="${actionUrl}" method="post" id="frm" name="frm" onsubmit="return regist()">
				...
				<div class="btn-cont ar">
					...
					<c:url var="listUrl" value="/rsv/rsvSelectList.do${_BASE_PARAM}"/>
