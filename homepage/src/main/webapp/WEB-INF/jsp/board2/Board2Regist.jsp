...
<!-- TinyMCE -->
<script src="https://cdn.tiny.cloud/1/plqakytlu0wfxsrtvs5ear700ef045zgqfk895k4whbo21c5/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
...
<div class="container">
	<div id="contents">
		<form action="${actionUrl}" method="post" id="frm" name="frm" onsubmit="return regist()" enctype="multipart/form-data">
			...
			<input type="hidden" name="returnUrl" value="/board2/board2Regist.do"/>
